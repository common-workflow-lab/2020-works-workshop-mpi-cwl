...
\author{\IEEEauthorblockN{
    Rupert W. Nash\IEEEauthorrefmark{1},
    Michael R. Crusoe\IEEEauthorrefmark{2}\IEEEauthorrefmark{3},
    Max Kontak\IEEEauthorrefmark{4}, and
    Nick Brown\IEEEauthorrefmark{1}
  }\\
  \IEEEauthorblockA{
    \IEEEauthorrefmark{1}
  ...
  \IEEEauthorblockA{\IEEEauthorrefmark{4}
    Institute for Software Technology, DLR German Aerospace
      Center, Cologne, Germany\\
    Email: max.kontak@dlr.de
  }
}
